...
export default function IntroSection() {
  ...
  return (
    ...
    >
      {/* Minimalist Editorial Corner Framing */}
      <div className="fixed inset-6 sm:inset-10 pointer-events-none z-20 flex flex-col justify-between opacity-40">
        <div className="flex justify-between items-start">
          <div className="w-3.5 h-3.5 border-t border-l border-[#c8a97e]/60" />
          <div className="w-3.5 h-3.5 border-t border-r border-[#c8a97e]/60" />
        </div>
        <div className="flex justify-between items-end">
          <div className="w-3.5 h-3.5 border-b border-l border-[#c8a97e]/60" />
          <div className="w-3.5 h-3.5 border-b border-r border-[#c8a97e]/60" />
        </div>
      </div>
      ...
      <div className="sticky top-0 w-full h-screen flex flex-col items-center justify-between py-12 sm:py-16 px-6 z-20 pointer-events-none">
        ...
        <div ref={footerRef} className="flex flex-col items-center text-center mb-4 sm:mb-6">
          <div className="px-5 py-2.5 rounded-full glass-panel mb-3 pointer-events-auto">
          ...
          <div className="w-[1.5px] h-6 bg-gradient-to-b from-[#c8a97e]/70 to-transparent animate-pulse mt-1" />
        </div>
      </div>
    </section>
  );
